...
.qr-lbl{{font-family:{font_family};font-size:clamp(.95rem,1.7vw,1.4rem);background:linear-gradient(135deg,{grad});-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:.06em;margin-bottom:clamp(5px,.9vw,10px);line-height:1.3}}
