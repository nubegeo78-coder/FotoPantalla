...
.qr{{position:absolute;right:0;bottom:0;width:clamp(150px,17vw,250px);background:rgba(0,0,0,.88);backdrop-filter:blur(24px);border-top-left-radius:clamp(14px,2.2vw,24px);border:1px solid rgba(255,255,255,.13);border-right:none;border-bottom:none;padding:clamp(12px,1.6vw,20px);padding-bottom:calc(clamp(36px,5.5vh,56px) + clamp(10px,1.2vw,16px));text-align:center;z-index:11;animation:slideqr 1.2s ease-out}}
