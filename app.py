...
async function load(){{
  ...
  const rc=await fetch('/api/counts');const counts=await rc.json();
  document.getElementById('cnt').textContent=counts.pending+' pend · '+counts.approved+' en pantalla';
...
async function onDrop(e){{
  ...
  await fetch('/api/photos/reorder-all',{{
    method:'POST',
...
@app.route('/api/photos/reorder-all', methods=['POST'])
@login_required
...
# ══════════════════════════════════════════════════════════
# COUNTS API — accurate counter for moderator panel
# ══════════════════════════════════════════════════════════
