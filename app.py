...
async function act(id,a){{const c=document.getElementById('c'+id);if(c){{c.style.opacity='.3';c.style.pointerEvents='none';}}await fetch('/api/photos/'+id+'/'+a,{{method:'POST'}});load();}}
            ...
            if os.path.exists(fp):
                ...
                with PILImage.open(fp) as img:
                    ...
                    if img.width > 1920:
                        ...
                        img = img.resize((1920, int(img.height*ratio)), PILImage.LANCZOS)
