...
/* ── Banner: full width bar at bottom, QR floats above on the right ── */
.banner{{
  position:absolute;bottom:0;left:0;right:0;
  height:clamp(38px,5.5vh,58px);
  background:rgba(0,0,0,.88);
  backdrop-filter:blur(16px);
  border-top:1px solid rgba(255,255,255,.1);
  display:flex;align-items:center;justify-content:center;
  z-index:10;
  animation:bannerIn 1.5s ease-out;
}}
...
.banner-qr img{{
  width:100%;max-width:clamp(110px,14vw,200px);
...
<div class="stage">
 <div class="canvas">
  ...
  <!-- bottom-right block: banner full width + QR sitting on top -->
  <div class="banner">
    <div class="banner-qr">
