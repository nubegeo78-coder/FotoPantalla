...
/* ── QR block sits flush on top of banner, no gap ── */
.qr{{
  position:absolute;
  right:0;
  bottom:0;
  ...
  border-top-left-radius:clamp(14px,2.2vw,24px);
  border-left:1px solid rgba(255,255,255,.13);
  border-top:1px solid rgba(255,255,255,.13);
  border-right:none;
  border-bottom:none;
  padding:clamp(12px,1.6vw,20px);
  padding-bottom:calc(clamp(38px,5.5vh,58px) + clamp(12px,1.6vw,20px));
  text-align:center;
  z-index:9;
  animation:slideqr 1.2s ease-out;
}}
