...
async function up(){{
  ...
  btn.disabled=true;document.getElementById('bt').textContent='⏳ COMPRIMIENDO...';
  document.getElementById('bar').style.display='block';document.getElementById('fill').style.width='30%';
  const compressed=await compress(f);
  document.getElementById('bt').textContent='⏳ ENVIANDO...';
  document.getElementById('fill').style.width='65%';
  const fd=new FormData();fd.append('photo',compressed,'foto.jpg');
  try{{
